...
export const Ficha = () => {
   ...
   return (
      <div className="p-2">
         ...
         <button className="flex items-center gap-2 text-lg m-auto mt-3 rounded px-3 py-1 bg-blade-700 hover:cursor-pointer print:hidden" onClick={() => {window.print()}}><FloppyDisk className="text-2xl " /> Salvar</button>
      </div>
   )
}